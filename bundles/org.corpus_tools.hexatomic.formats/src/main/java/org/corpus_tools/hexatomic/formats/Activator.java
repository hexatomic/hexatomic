...
public class Activator implements BundleActivator {
  ...
  private static final String[] BUNDLE_LOCATIONS =
      {"exmaralda-emf-api-1.2.2.jar", "gson-2.8.7.jar", "pepperModules-EXMARaLDAModules-2.0.0.jar",
          "pepperModules-GraphAnnoModules-2.0.1.jar", "pepperModules-PAULAModules-1.3.0.jar"};
